...
export default function CancelledDetail() {
	return (
		<>
			<button className="absolute top-20 left-2 hover:bg-gray-200 hover:rounded-sm">
				<Link href="/my-reservations/cancelled" className="flex">
					<Image
						src={"/svg/back.svg"}
						alt="previous"
						className="w-6 h-6 "
			...
			<section className="w-11/12 mx-auto my-20">
				...
				{/* Cancel */}
				<div className="w-11/12 mx-auto mt-12 p-4 rounded-lg bg-red-200 text-red-600 flex">
					<Image
						src={"/svg/warning.svg"}
						alt="warning"
						width={20}
					...
					/>
					<div className="ml-4">
						<h3 className="font-semibold">Cancellation in Progress </h3>
						<p>
							Your cancellation request is being verified. Please wait while we
							process it.
						</p>
					</div>
				</div>
				...
				<div className="w-11/12 mx-auto mt-12 mx-auto leading-[45px]">
					...
					<div className="flex justify-between items-center w-11/12 mx-auto">
						...
						<p className="text-start w-1/3">Cancelled</p>
					</div>
				</div>
			</section>
		</>
