...
const TestimonialsCarousel = () => {
	return (
		<section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 mt-24 w-11/12 xl:w-full">
			<div className="text-center mb-10">
				<h2 className="text-4xl font-bold text-gray-900">
					What our happy guests says!
				</h2>
				<span className="text-sm text-gray-500 font-medium block mt-4">
					TESTIMONIAL
				</span>
			</div>
			<Swiper
			...
			>
				...
				{/* Tambahkan SwiperSlide lainnya di sini */}
			</Swiper>
		</section>
	);
};
