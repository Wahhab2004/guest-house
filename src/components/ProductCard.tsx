		...
		<div className="container max-w-7xl mx-auto px-4 py-8 my-10 md:w-11/12 xl:w-full">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-6 mt-2 mx-auto ">
				{room.map((room) => (
					<div
						key={room.id}
						className="w-full bg-white border-2 border-gray-200 rounded-lg shadow-xl"
					>
						<Link href="#">
							<Image
						...
						<div className="px-5 pb-5">
							...
							<div className="flex items-center justify-between">
								...
								<Link
									href={`/rooms/${room.id}`}
									className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center lg:ml-2 "
								>
									Booking Room
								</Link>
							</div>
