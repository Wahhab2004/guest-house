...
const PaymentForm = ({handleNavigate}: BookingDetailsProps) => {
    ...
    return (
        <div className="w-[85%] mx-auto" id="payment">
            {/* Heading */}
            <h1 className="text-xl lg:text-3xl font-bold text-center mt-10 text-blue-900">Payment & Confirmation</h1>
            ...
            <form className="space-y-5 my-10">
                ...
                {(selectedPaymentMethod === "bank-bca" ||
                    selectedPaymentMethod === "japan-post-bank") && (
                    <>
                        <div className="bg-white p-4 border border-gray-300 rounded-lg">
                            ...
                            <div className="mt-4">
                                ...
                                >
                                    ...
                                    <Link href="https://wa.me/6282117934065">
                                        Send Payment Proof to WhatsApp
                                    </Link>
                                </button>
                                <p className="text-sm text-gray-600 mt-2">
                                    Faster verification with WhatsApp. Make sure to include your
                                    booking ID.
                                </p>
                            </div>
                        </div>
                    ...
                    <>
                        <div className="bg-white p-4 border border-gray-300 rounded-lg">
                            ...
                            <div className="bg-white rounded-lg mt-4">
                                ...
                                <div className="mt-4">
                                    <button
                                        type="button"
                                        className="flex items-center bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-300 w-full "
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            x="0px"
                        ...
                        <div className="pt-10">
                            <button
                                ...
                                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-[50%] sm:w-auto px-5 py-2.5 text-center 
                            mx-auto block lg:w-1/3"
                                onClick={() => handleNavigate("summary-booking")}
                            >
                                Booking
                            </button>
